  ...
  <div class="comfirmBox">
    ...
    <div class="test" v-if="confirmBox.isShow">
      ...
      <div class="messageBxo">
        ...
        <div class="payStyle">
          ...
          <div class="name" v-if="confirmBox.payType === 2">{{confirmBox.str}}尾号{{confirmBox.bankCardNo | bankCardShow}}<img src="~@/assets/images/back2_icon@2x.png" @click="payStyleBox.isShow = true;" alt=""></div>
          <div class="name" v-if="confirmBox.payType === 1">余额支付<img src="~@/assets/images/back2_icon@2x.png" @click="payStyleBox.isShow = true;" alt="" srcset=""></div>
        </div>
        <div class="payStyle">
    ...
    <div class="test" v-if="payStyleBox.isShow">
      ...
      <div class="messageBxo">
        ...
        <div class="title">
          支付方式
          <img src="~@/assets/images/back_icon@2x.png" width="23" height="23" alt="" class="close" @click="payStyleBox.isShow = false">
        </div>
        ...
        .then(res => {
          ...
          .then(res => {
            if (res.code === 200) {
              ...
              this.params.requestno  = res.requestno;
